    ...
    <div  >
      ...
      >
        <nav className="flex flex-col space-y-4">
          <Link href="profile" className="text-white hover:text-gray-300" onClick={() => setIsOpen(false)}>
            Profile
          </Link>
          <Link href="profile" className="text-white hover:text-gray-300" onClick={() => setIsOpen(false)}>
            My routes
          </Link>
          <Link href="/deconnect" className="text-white hover:text-gray-300" onClick={() => setIsOpen(false)}>
            Deconnexion
          </Link>
        </nav>
      </div>
